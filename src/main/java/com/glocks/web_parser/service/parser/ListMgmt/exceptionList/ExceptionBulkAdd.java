...
@Service
public class ExceptionBulkAdd  implements IRequestTypeAction {
    ...
    public void executeValidateProcess(WebActionDb webActionDb, ListDataMgmt listDataMgmt) {
        ...
        try {
            ...
            if(!fileOperations.checkFileExists(filePath)) {
                ...
                alertService.raiseAnAlert(transactionId,"alert5701", "List Mgmt Exception List", currentFileName + " with transaction id " + transactionId, 0);
...
//            int successCount = 0, failedCount = 0;
            try(BufferedReader reader = new BufferedReader( new FileReader(filePath))) {
                ...
                while((record = reader.readLine()) != null) {
                    ...
                    boolean status = exceptionListUtils.processExceptionSingleAddEntry(listDataMgmt, listMgmtDto, 0, writer);
